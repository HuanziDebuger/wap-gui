...
//引入数据data
import compsData from './data/toastData.jsx';
//引入组件源码
import codeData from './data/code.jsx';

export default class Radio extends React.Component {
  render() {
      const href='http://10.58.56.93:8081/examples/#/toast';
            ...
            <div style={pagesTop}>
             ...
             <div className="codeBox">
               <Card title="代码调用示例" style={{width:'100%',marginBottom:'20px'}}>
                 <textarea style={textareaStyle} disabled="disabled">
                   {compsData.codeHTML.html}                    
                </textarea>
               </Card>
