...
//引入数据data
import compsData from './data/imageData.jsx';
//引入组件源码
import codeData from './data/code.jsx';

export default class Radio extends React.Component {
  render() {
      const href='http://10.58.56.93:8081/examples/#/image';
        ...
        <div className="content">
            <div style={pagesTop}>
              ...
              <Card title="API参数" style={{flex:1}}>
                <Table columns={compsData.tableHead} dataSource={compsData.tableBody} bordered />
              </Card>
            </div>
